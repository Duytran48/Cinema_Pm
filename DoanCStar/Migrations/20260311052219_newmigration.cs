        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Subtitle = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SnackOrders_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SnackOrderDetails", x => x.DetailId);
                    table.ForeignKey(
                        name: "FK_SnackOrderDetails_Concessions_ConcessionId",
                        column: x => x.ConcessionId,
                        principalTable: "Concessions",
                        principalColumn: "ConcessionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SnackOrderDetails_SnackOrders_SnackOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingConcessionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookingId = table.Column<int>(type: "int", nullable: false),
                    ConcessionId = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingConcessions", x => x.BookingConcessionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SnackOrderDetails_ConcessionId",
                table: "SnackOrderDetails",
                column: "ConcessionId");

            migrationBuilder.CreateIndex(
                name: "IX_SnackOrderDetails_SnackOrderId",
                table: "SnackOrderDetails",
                column: "SnackOrderId");
